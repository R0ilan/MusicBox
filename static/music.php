<!doctype html>
  ...
  <head><script src="js/color-modes.js"></script>
    ...
    <div class="container">
      ...
      <div class="nav-scroller py-1 mb-3 border-bottom">
        <nav class="nav nav-underline justify-content-between">
          <a class="nav-item nav-link link-body-emphasis" href="#">PROFILE</a>
          <a class="nav-item nav-link link-body-emphasis" href="#">HOME</a>
          <a class="nav-item nav-link link-body-emphasis active" href="#">MUSIC</a>
          <a class="nav-item nav-link link-body-emphasis" href="#">FAQ</a>
    ...
    <div class="row mb-2"> <!-- clicking on each image will lead to the artists profile page-->
        <div id="ftArtists" class="col-md-6 border rounded">
            <div class="col-auto d-none d-lg-block">
              <div id="content" class="bodySec">
                ...
                <br>
                <p class="ft">Featured Artists</p>
              </div>
            </div>
          
        </div>
        <div id="ftAlbums" class="col-md-6 border rounded"> <!-- Clicking on each album will link to the page of reviews for that album-->
            <div class="col-auto d-none d-lg-block">
              <div class="container text-center">
                <div class="row align-items-center">
                  <div class="col">
